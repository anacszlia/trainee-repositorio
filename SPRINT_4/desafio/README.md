...
## Etapa 2
A resposta para o questionamento está em [resposta](./desafio/respostas_questionamentos.md)

## Etapa 3
É necessário fazer o download do arquivo [dockerfile](./desafio/etapa3/dockerfile) e o arquivo [script](./desafio/etapa3/script.py) e executar os dois últimos comandos em [comandosLog](./desafio/comandos.log)
